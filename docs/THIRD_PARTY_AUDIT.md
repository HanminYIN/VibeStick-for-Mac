...
M3-B + M3-C local checkpoint on 2026-08-13.
...
| `firmware/sticks3/generated/vibe_stick_ui_10.c` and `vibe_stick_ui_12.c` | Generated from Noto Sans CJK SC Regular | Uncompressed compact LVGL glyph subsets for fixed Chinese home-screen and M3-B voice labels | Source font is SIL Open Font License 1.1, copyright Adobe 2014-2021 | Medium | Keep with NOTICE attribution. Do not use the reserved Source name as a VibeStick brand. |
