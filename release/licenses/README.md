...
0.2.0 RC 1. App/DMG packaging copies these tracked notices so a clean source or
tag snapshot does not depend on an ignored ESP-IDF checkout, managed-components
directory, or toolchain cache.
