...
M4-5K and reused by VibeStick for Mac 0.2.0 RC 1. The directory intentionally
contains only the three flash images and `manifest-v1.json`; the payload
validator rejects extra files, changed modes, changed offsets, and hash drift.
